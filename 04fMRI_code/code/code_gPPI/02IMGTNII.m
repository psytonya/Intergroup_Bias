...
for j = 1:length(subFolders)
    % 构建每个子文件夹下的特定路径
    subFolderPath = fullfile(rootPath, subFolders(j).name, 'NO_slice_analysis_8conds_1noRT_dur0_f128', 'PPI_MASK_PPC_29_-58_41');
...
for k = 1:length(subFolders)
    ...
    subFolderPath = fullfile(rootPath, subFolders(k).name,...
        'NO_slice_analysis_8conds_1noRT_dur0_f128','PPI_MASK_mPFC_6_50_14');
...
for l = 1:length(subFolders)
    % 构建每个子文件夹下的特定路径
    subFolderPath = fullfile(rootPath, subFolders(l).name, 'NO_slice_analysis_8conds_1noRT_dur0_f128', 'PPI_MASK_dlPFC_-54_20_30');
...
for m = 1:length(subFolders)
    % 构建每个子文件夹下的特定路径
    subFolderPath = fullfile(rootPath, subFolders(m).name, 'NO_slice_analysis_8conds_1noRT_dur0_f128', 'PPI_MASK_dACC_-8_20_46');
