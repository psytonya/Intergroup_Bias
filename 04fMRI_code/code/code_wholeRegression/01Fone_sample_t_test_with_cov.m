...
cov_info = {
    'behavior', 'B2:B58', 'Fout_in',        'Group_cov_FT';
    'parameter','C2:C58', 'thetaOUT_IN',    'Group_cov_thetaT';
    'parameter','D2:D58', 'betaOUT_IN',     'Group_cov_betaT';
};

% 读取数据路径
img_path = 'E:\no_slice_timing\data\Group_analysis\NO_slice_analysis_8conds_1noRT_dur0_f128\con_0033_fair(out-in)';
